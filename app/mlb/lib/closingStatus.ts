...
import { exportSignals } from "@/app/mlb/lib/exportSignals";

export type MlbPickStatus =
  | "pending"
  | "confirmed"
  | "downgraded"
  | "removed"
...
export function readClosingStatus(): ClosingStatusEntry[] {
  ...
  try {
    ...
    console.error("Error reading MLB closingStatus.json:", error);
    return [];
  }
}
